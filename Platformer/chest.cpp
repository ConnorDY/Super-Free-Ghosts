...
void Chest::updateAnimation(sf::Time deltaTime)
{
	...
	if (frames > 1)
	{
		...
		if (frame > (float)(frames - 1))
		{
			...
			{
				PlayerWeapon::Enum options[] = { PlayerWeapon::SPEAR, PlayerWeapon::HAMMER, PlayerWeapon::TRIDENT, PlayerWeapon::SWORD, PlayerWeapon::AXE, PlayerWeapon::WAR_HAMMER, PlayerWeapon::MACE };
